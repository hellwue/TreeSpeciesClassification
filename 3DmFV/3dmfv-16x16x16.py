...
class Net_3DmFV(pl.LightningModule):
    def __init__(
        self,
        train_data_path="./data/train_16x16x16.pickle",
        val_data_path="./data/val_16x16x16.pickle",
        test_data_path="./data/test_16x16x16.pickle",
        batch_size=644,
        lrschedule=True,
    ):
        super().__init__()
        ...
        self.inception0 = Inception(20, 64, 4, 8)
        self.inception1 = Inception(64 * 3, 128, 4, 8)
        self.inception2 = Inception(128 * 3, 256, 4, 8)
        # self.maxpool0 = MaxPool3d(2, 2)
        self.inception3 = Inception(256 * 3, 256, 3, 5)
        self.inception4 = Inception(256 * 3, 512, 3, 5)
        # self.maxpool1 = MaxPool3d(2, 2)
        self.inception5 = Inception(512 * 3, 512, 2, 3)
        self.inception6 = Inception(512 * 3, 512, 2, 3)
        self.maxpool = MaxPool3d(2, 2)

        self.lin0 = Lin(512 * 3 * 2 ** 3, 1024)
