...
class Net_3DmFV(pl.LightningModule):
    def __init__(
        self,
        train_data_path="./data/train_3x3x9.pickle",
        val_data_path="./data/val_3x3x9.pickle",
        test_data_path="./data/test_3x3x9.pickle",
        batch_size=64,
        lrschedule=True,
    ):
        super().__init__()
        ...
        self.inception0 = Inception(20, 64, 2, 3)
        self.inception1 = Inception(64 * 3, 128, 2, 3)
        self.inception2 = Inception(128 * 3, 256, 2, 3)
        self.inception3 = Inception(256 * 3, 256, 2, 3)
        self.inception4 = Inception(256 * 3, 512, 2, 3)

        self.lin0 = Lin(512 * 3 * (3 * 3 * 9), 1024)
