...
MODEL_NAME = 'geom+n+i_scaled+ms'


train_dataset = load_dataset(
    './data/train_s.h5', batch_size=16, shuffle=True, load_ms=True)
val_dataset = load_dataset(
    './data/val_s.h5', batch_size=16, load_ms=True)
test_dataset = load_dataset(
    './data/test_s.h5', batch_size=16, load_ms=True)
