...
class PointCNN(pl.LightningModule):
    def __init__(self, numfeatures=9):
        super().__init__()
...
MODEL_NAME = 'geom+n+i_scaled+ms_notinlin'


train_dataset = load_dataset(
    './data/train_s.h5', batch_size=16, shuffle=True)
val_dataset = load_dataset(
    './data/val_s.h5', batch_size=16)
test_dataset = load_dataset(
    './data/test_s.h5', batch_size=16)
