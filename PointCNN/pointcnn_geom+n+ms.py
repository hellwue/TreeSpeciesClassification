...
MODEL_NAME = 'geom+n+ms'


train_dataset = load_dataset(
    './data/train.h5', batch_size=16, shuffle=True, load_ms=True, load_intens=False)
val_dataset = load_dataset(
    './data/val.h5', batch_size=16, load_ms=True, load_intens=False)
test_dataset = load_dataset(
    './data/test.h5', batch_size=16, load_ms=True, load_intens=False)
