...
train_dataset = load_dataset(
    '../../0_data/hdf/train.h5', batch_size=16, shuffle=True, load_intens=False)
val_dataset = load_dataset(
    '../../0_data/hdf/val.h5', batch_size=16, load_intens=False)
test_dataset = load_dataset(
    '../../0_data/hdf/test.h5', batch_size=16, load_intens=False)

# model = PointCNN(numfeatures=0).load_from_checkpoint(
