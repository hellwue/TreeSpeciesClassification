import pickle
from myutils import call_home, CMDisplay
from myutils import load_dataset_special as load_dataset
...
class PointCNN(pl.LightningModule):
    def __init__(self, numfeatures=8):
        super().__init__()
...
MODEL_NAME = 'geom+n+ms_notlin'


train_dataset = load_dataset(
    './data/train.h5', batch_size=16, shuffle=True, load_intens=False)
val_dataset = load_dataset(
    './data/val.h5', batch_size=16, load_intens=False)
test_dataset = load_dataset(
    './data/test.h5', batch_size=16, load_intens=False)
