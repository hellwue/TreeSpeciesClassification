...
from myutils import load_dataset_scaleintens as load_dataset
...
MODEL_NAME = 'geom+i_scaled_i'


train_dataset = load_dataset(
    '../../0_data/hdf/train.h5', batch_size=16, shuffle=True)
val_dataset = load_dataset(
    '../../0_data/hdf/val.h5', batch_size=16)
test_dataset = load_dataset(
    '../../0_data/hdf/test.h5', batch_size=16)
...
with open(f'./results/{MODEL_NAME}_res.pickle', 'wb') as file:
